...
![Figure 4-26: Reference UPV node, view of the aggregated data from the reference node catalogue (left) and Zenodo (right).](figures/image4-26.png)
...
![Figure 4-27: Reference UPV node, view of the aggregated data from the reference node catalogue (left) and Zenodo (right).](figures/image4-27.png)
